...
{
if ((t.hour>=alarm.hour) &&(t.hour<=alarm_stop.hour))
  {
    if ((t.min>=alarm.min) || (t.min>=alarm_stop.min))
    {
...
Serial.println((String)"temp act"+rtc.getTemp());
Serial.println((String)"temp max"+temp_SDB);
